...
dataset_path = '/datasets/aicitychallenge2023'
data_path = '/datasets/aicitychallenge2023'
...
_C.DATA.TRAIN_JSON_PATH = "/datasets/aicitychallenge2023/train.json"
_C.DATA.EVAL_JSON_PATH = "/datasets/aicitychallenge2023/val.json"
...
_C.DATA.TEST_TRACKS_JSON_PATH = "/datasets/aicitychallenge2023/test-tracks.json"
...
_C.DATA.USE_OSS = True  # set True if using OSS
_C.DATA.OSS_PATH = 's3://aicitychallenge2023/'
_C.DATA.CROP_AUG = False
_C.DATA.TEXT_AUG_SPLIT = ''


_C.DATA.TEXT_AUG_TYPE = ('suv', 'sedan', 'truck', ('van', 'wagon')) #wagon
_C.DATA.TEXT_AUG_MOTION = ('left','right','stop') #straight
_C.DATA.TEXT_AUG_COLOR = ('red', 'blue', 'black', 'white', ('gray','silver', 'grey')) #silver, grey
_C.DATA.TEXT_AUG_SIZE = (('small', 'mini'), ('midsize', 'medium', 'mid-sized'), ('large','big', 'huge', 'massive', 'giant'))
_C.DATA.TEXT_AUG_INTER = 'intersection'
_C.DATA.USE_FEATS_QUERY = False
_C.DATA.USE_FEATS_AUG_TEXT = False
_C.DATA.FEAT_ENG = False
...
# local aggr
_C.MODEL.PROJ_DIM = 5
_C.MODEL.USE_NON_LINEAR_PROJ = False
...
_C.MODEL.HEAD.USE_METRIC_LOSS = True

_C.MODEL.FEATS_AGGR_WEIGHT = 1
...
_C.TEST.QUERY_JSON_PATH = "/datasets/aicitychallenge2023/test-queries.json"
