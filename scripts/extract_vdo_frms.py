...
def main(args):
    ...
    rootPath = os.path.join(dirname, args.data_root)
    seq_list = os.listdir(rootPath)

    for seq_name in seq_list:
        path_data = os.path.join(rootPath, seq_name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', dest='data_root', default='train/S01',
